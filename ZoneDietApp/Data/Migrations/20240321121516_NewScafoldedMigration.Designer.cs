...
namespace ZoneDietApp.Data.Migrations
{
    ...
    [Migration("20240321121516_NewScafoldedMigration")]
    partial class NewScafoldedMigration
    {
            ...
            modelBuilder.Entity("ZoneDietApp.Data.Models.RecipeProduct", b =>
                {
                    ...
                    b.Property<decimal>("TypeQuantity")
                        .HasColumnType("decimal(18,2)")
                        .HasComment("Number of blocks of the product");
                    ...
                    b.HasIndex("RecipeProductTypeId");
            ...
            modelBuilder.Entity("ZoneDietApp.Data.Models.RecipeProduct", b =>
                {
                    ...
                    b.HasOne("ZoneDietApp.Data.Models.ProductTypeOption", "RecipeProductType")
                        .WithMany()
                        .HasForeignKey("RecipeProductTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RecipeProductType");
                });
